...
public class Main {
    ...
    // Metodo perimetroRettangolo: calcola il perimetro del rettangolo
    public static int perimetroRettangolo(int altezza, int base) {
        return 2 * (altezza + base);  // Perimetro di un rettangolo è 2*(altezza + base)
    }
    ...
    public static void main(String[] args) {
        ...
        // Chiediamo all'utente di inserire il valore della base
        ...
        // Stampiamo il risultato del perimetro del rettangolo
